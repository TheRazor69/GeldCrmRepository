   ...
   <!-- Navigation -->
    ...
    <div class="container">
        ...
        <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i>Adiciona</h4>
                    </div>
                    <div class="panel-body">
                        <p>Aqui podera adicionar os seus clientes</p>
                        <a href="#" class="btn btn-default">executa</a>
                    </div>
                </div>
            </div>
        <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i>Edita</h4>
                    </div>
                    <div class="panel-body">
                        <p>Aqui podera editar os dados dos clientes</p>
                        <a href="#" class="btn btn-default">executa</a>
                    </div>
                </div>
            </div>
        <div class="col-md-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i>Remove</h4>
                    </div>
                    <div class="panel-body">
                        <p>Aqui podera remover um cliente inserido.</p>
                        <a href="#" class="btn btn-default">executa</a>
                    </div>
                </div>
            </div>
...
*/
	...
	echo "<p><b>View All</b> | <a href='view-paginatedempresas.php?page=1'>View Paginated</a></p>";
	
	echo "<table border='1' cellpadding='10'>";
	echo "<tr> <th>ID</th> <th>nomeempresa</th> <th>contacto</th> <th>localizacao</th> <th>nomepessoacontactar</th> <th>endemail</th><th></th> <th></th></tr>";
	...
	while($row = mysql_fetch_array( $result )) {
        ...
        echo '<td>' . $row['nomepessoacontactar'] . '</td>';
        echo '<td>' . $row['endemail'] . '</td>';
		echo '<td><a href="editempresas.php?id=' . $row['id'] . '">Edit</a></td>';
		echo '<td><a href="deleteempresas.php?id=' . $row['id'] . '">Delete</a></td>';
		echo "</tr>"; 
	} 
	...
	echo "</table>";
?>
<p><a href="newempresas.php">Add a new record</a></p>
