...
*/
	...
	echo "<p><a href='Adicionaempresa.php'>View All</a> | <b>View Page:</b> ";
	for ($i = 1; $i <= $total_pages; $i++)
	{
		echo "<a href='view-paginatedempresas.php?page=$i'>$i</a> ";
	}
	echo "</p>";	
	...
	for ($i = $start; $i < $end; $i++)
	{
		...
		echo '<td>' . mysql_result($result, $i, 'nomeempresa') . '</td>';
		echo '<td>' . mysql_result($result, $i, 'contacto') . '</td>';
        echo '<td>' . mysql_result($result, $i, 'localizacao') . '</td>';
        echo '<td>' . mysql_result($result, $i, 'nomepessoacontactar') . '</td>';
        echo '<td>' . mysql_result($result, $i, 'endemail') . '</td>';
		echo '<td><a href="editempresas.php?id=' . mysql_result($result, $i, 'id') . '">Edit</a></td>';
		echo '<td><a href="deleteempresas.php?id=' . mysql_result($result, $i, 'id') . '">Delete</a></td>'; 
		echo "</tr>"; 
	}
	// close table>
	echo "</table>"; 
